...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        to: ROUTES.ADMIN_SESSIONS, label: 'الحصص والجداول',
        ...
        <div className="sticky top-0 z-20 flex items-center justify-between gap-4 px-5 h-16 bg-white border-b border-gray-200">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <NavLink
              ...
              className="relative w-9 h-9 rounded-xl flex items-center justify-center text-gray-500 hover:bg-gray-100 transition-colors border border-gray-200"
            >
              <svg width="17" height="17" viewBox="0 0 24 24" fill="none">
