              ...
              <div key={req._id} className="card-light p-4 hover:shadow-md transition-shadow">
                <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                  ...
                  <div className="flex-none sm:w-44">
                    ...
                    <div className="text-xs text-[#9b7fd6]">{req.amount} — {PAYMENT_METHOD_LABELS[req.paymentMethod] || req.paymentMethod}</div>
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-3 p-4 rounded-xl bg-[#f8f5ff]">
              ...
              <div>
                ...
                <div className="text-sm text-[#9b7fd6]">الباقة: <span className="font-semibold">{selectedRequest.packageId?.nameAr}</span> — {selectedRequest.amount}</div>
              </div>
