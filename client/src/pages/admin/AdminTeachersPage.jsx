  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3 py-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          <label className="text-xs font-bold text-gray-400 mb-1 block">الراتب / الحصة</label>
              ...
              <div className="py-4 border-b border-gray-100">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div className="flex flex-col items-center p-3 rounded-xl" style={{ background: teacher.salaryPerSession ? '#f0fdf4' : '#f9fafb' }}>
                    ...
                    <div className="text-xs mt-0.5" style={{ color: teacher.salaryPerSession ? '#16a34a' : '#9ca3af' }}>/ حصة</div>
                  </div>
                </div>
              </div>
